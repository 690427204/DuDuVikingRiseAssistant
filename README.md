...
**重要说明**：下载即可获得基础采集功能，联系作者可获得三天完整版体验权。联系作者：QQ: 690427204, Discord: dudu007081
...
2. **授权管理**：
   ...
   - **联系作者：QQ: 690427204, Discord: dudu007081**
...
## 2. 性能设置
![性能设置](images/performance_setting.png)
- 点击左侧菜单中的**性能**选项
- 将CPU设置为**2核心**（推荐）
- 将内存设置为**4GB**（推荐）
- 点击**保存**按钮应用更改
...
## 4. ADB调试设置
![ADB调试设置](images/adb_setting.png)
- 点击左侧菜单中的**高级**选项
- 找到**Android调试(ADB)**部分
